package org.dl;
	...
	public class DataAnalysis{
		...
		public static void main(String args[]) {
			...
			try {
			Table insurance_data=Table.read().csv("C:\\Users\\hp\\Desktop\\1214\\org.dl\\src\\main\\java\\org\\dl\\Vehicle12.csv");
			...
			//box-plot
			BoxTrace t1=BoxTrace.builder(insurance_data.categoricalColumn("fraud_reported"), insurance_data.nCol("vehicle_claim")).build();
			Plot.show(new Figure(l1,t1));
			//scatter-plot
			ScatterTrace s=ScatterTrace.builder(insurance_data.nCol("policy_annual_premium"),insurance_data.nCol("vehicle_claim")).build();
			Plot.show(new Figure(l1,s));
			}
			catch(IOException e) {
				e.printStackTrace();
			}
			Instances train_data = getInstances("C:\\Users\\hp\\Desktop\\Train.arff");
			Instances test_data = getInstances("C:\\Users\\hp\\Desktop\\Test.arff");
